...
- **[Evaluating skill output quality](/skill-creation/evaluating-skills)** — Set up test cases, grade results, and iterate on your skill systematically.
- **[Using scripts in skills](/skill-creation/using-scripts)** — Bundle executable scripts and one-off commands the agent can run.
